...
const Playgrounds = () => {
  ...
  return (
    <div className="bg-white p-6">
      <h1 className='text-2xl mx-2 font-bold mb-2'>All Playgrounds</h1>
          ...
          fields.map((field) => (
            ...
            >
              ...
              <p className="text-gray-600">
                {field.price_per_hour ? `$${field.price_per_hour}` : 'Price not available'}
              </p>
              <button className='bg-gray-500 hover:bg-gray-600 text-white px-4 py-1 rounded-lg transition'>Reserve</button>
            </div>
          ))
        )}
      </div>
